    ...
    <div className="grid grid-flow-col p-5 m-2 shadow-lg flex items-center">
      ...
      <div className="col-span-10 px-10 relative">
        ...
        <div className='absolute m-1 border border-2 rounded bg-white w-1/2'>
          {suggestions &&
            suggestions.map((suggestion)=><div key={suggestion} className='m-2 hover:bg-gray-200'>
              {suggestion}
            </div>)
          }
        </div>
