...
const Head = () => {
  ...
  const navigateToSearch = () => {
    navigate(
      `/results?search_query=${searchQuery.trim().split(" ").join("+")}`
    );
  };
  ...
  return (
    <div
      id="headerId"
      className="grid grid-flow-col p-1 m-1 shadow-['0px_25px_20px_-20px_rgba(0,0,0,0.45)'] items-center"
    >
      ...
      <div className="col-span-10 relative">
        ...
        <button
          ...
          className="bg-gray-300 rounded-lg rounded-l-none p-2"
        >
          search
        </button>
        {/* </Link> */}
