...
const searchResultList1 = [
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "Hello everyone welcome to channel : Animals Appaloosa Official Help me!! 100K Subscriber. Thank you.",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "title": "One side love does hurt 💔🥺 [Yuki, Itsuomi, Oushi] A sign of Affection #animeedit #viral #fyp",
      "description": "Copyright info: Under section 107 of the copyright Act 1976 of U.S law, allowance is made for \"fair use\" for purposes such as ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "wait for end    Tom and Jerry       Cute Story #shorts #ytshorts.",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "Cómo derrotar a estos personajes #datoscuriosos #minecraft #curiosidades #personajes #derrotar #disney #marvel.",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "Coldplay - Adventure Of A Lifetime is taken from the album A Head Full of Dreams released in 2015 Subscribe for more content ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "i Survived the World's STRICTEST Babysitter! Today Ferran has to Survive 24 hours with the worlds strictest babysitter!",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "title": "#EnVivo ¬ #LosPeriodistas ¬ ¿Cuánto debe Salinas Pliego? ¬ Cárdenas arropa a Claudia Sheinbaum",
      "description": "Visita www.sinembargo.mx Facebook: www.facebook.com/SinEmbargoMX Twitter: www.twitter.com/SinEmbargoMX Instagram: ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "COMPRA TUS BOLETOS PARA NUESTRA GIRA FLOW PICUS 2023   LINK    : https://solo.to/picus_pfmusic-gts INVITADOS: ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "title": "Phonics Song 2 with TWO Words in 3D - A For Airplane - ABC Alphabet Songs with Sounds for Children",
      "description": "You can listen to this song on your preferred music streaming platforms.- https://orcd.co/velm61p ChuChu and Friends introduce ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "Start a business with Shopify today! https://shopify.com/prestongoes Music licensed from Lickd. The biggest mainstream and ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "title": "Phonics Song for Toddlers | A for Apple | Phonic Sounds of Alphabet A to Z | Kids Rhyme | Color more",
      "description": "Embark on a delightful educational journey with our latest YouTube video designed especially for kids! This video is a colorful ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "Vlad and Niki The best stories for kids | 1 Hour Video 00:00 Vlad and Niki kids story about sweet machine 4:34 Vlad and Niki play ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "title": "#AA letter love couple name status|| AA love whatsapp status|| Love song status||#status #ytshorts",
      "description": "AA letter love couple name status|| AA love whatsapp status|| Love song status||#status #ytshorts ᴛʜᴀɴᴋ ʏᴏᴜ ғᴏʀ ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "Bounce along in the bus all over town with this favorite nursery rhyme!",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "title": "CONTRATE UNA CHICA para SUBIR a HEROICO en FREE FIRE !! | TheDonato",
      "description": "SIGUE LA REDES DE LOS CHAMOS FC !! Twitter: https://twitter.com/LosChamosFC Instagram: ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "shorts WE LOVE YOU lots of fun photos coming your way on Instagram: @abbyelizabethoward @_matt_howard_ also... you ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "title": "&#39;Dune: Part Two&#39; Director Denis Villeneuve Breaks Down a Scene | Vanity Fair",
      "description": "'Dune: Part Two' director Denis Villeneuve breaks down the glorious scene where Paul Atreides (Timothée Chalamet) uses the ...",
      "thumbnails": {
        "default": {
...
const videoList = [
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "JavaScript Tutorial for beginners in hindi and urdu in most easiest way.This javascript crash course in hindi explain you every ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "Join my FREE JavaScript Course: https://www.cleverprogrammer.com FORK THIS REPL ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "title": "JavaScript Tutorial for Beginners | Full Course to Learn What is JavaScript in Hindi",
      "description": "In this free JavaScript tutorial for beginners in Hindi from WsCube Tech, you will learn the programming language from basic to ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "GitHub Code Repo: https://github.com/KG-Coding-with-Prashant-Sir/JavaScript_Complete_YouTube - Completion Certificate: ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "In this video series i will cover javascript programming language from basic to advance level step by step in hindi.",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "title": "Java Script Full Course in Telugu | Java Script in Telugu | Java Script Tutorials in Telugu",
      "description": "Click Here for Python Course in Telugu https://pythonlife.in/python-course-in-telugu.html GitHub link: ...",
      "thumbnails": {
        "default": {
  ...
  },
  {
    ...
    "snippet": {
      ...
      "description": "Welcome, to Complete JavaScript Tutorial for Beginners in Hindi in 2024. We will cover Basic to Advanced JavaScript, Modern ...",
      "thumbnails": {
        "default": {
...
const SearchList = () => {
  ...
  useEffect(() => {
    console.log("38 location.search");
    setSearchText(location.search.substring(14))
    ...
    <div class="pr-40 py-3" >
      {searchResultList?.map((video) => (
        <Link key={video.id.videoId} to={"/watch?v=" + video.id.videoId}>
          <div class="flex mb-2">
              <div class="w-4/12 overflow-hidden rounded-lg h-52 bg-slate-700">
            ...
            <div class="w-7/12 p-5">
              <p class="text-xl font-medium">{video.snippet.title}</p>
              <p onClick={()=>channelLinkClick()} class="font-light text-xs my-2 hover:font-normal">{video.snippet.channelTitle}</p>
              {/* <span>
              <p>{video.views}</p>
              <p>{video.how_old}</p>
            </span>
